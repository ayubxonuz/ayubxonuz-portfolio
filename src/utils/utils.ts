export const projects = [
  ...
  },
  {
    ...
    technology: "ReactJS, React Router DOM, Firebase",
  ...
  },
  {
    ...
    technology:
      "ReactJs, Redux Toolkit, Firebase Auth,  TailwindCSS, DaisyUI, API",
  ...
  },
  {
    ...
    technology: "ReactJs, Redux Toolkit,  TailwindCSS, DaisyUI, API",
    title: "Invoices-app",
    info: "Invoices is a website for viewing and receiving payment history. (fake)",
  },
  {
    id: 7,
    image: "/comfyStore.png",
    githubLink: "https://github.com/ayubxonuz/comfy-store",
    siteLink: "https://ayubxonuz-comfy-store.vercel.app",
    technology: "ReactJs, Daisyui, TailwindCSS, Redux-Toolkit, React-Query",
    title: "Comfy-store",
    info: "You must register to view information. The product can be purchased and more. (fake)",
  },
]
